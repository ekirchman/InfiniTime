    ...
    screen {[this, &settingsController]() {
      switch (settingsController.GetWatchFace()) {
        ...
        case WatchFace::WatchFaceHybrid:
          ...
          break;
        case WatchFace::WatchFaceFEPT:
          return WatchFaceFEPTScreen();
          break;
      }
      return WatchFaceDigitalScreen();
    }()} {
...
std::unique_ptr<Screen> Clock::WatchFaceHybridScreen() {
  return std::make_unique<Screens::WatchFaceHybrid>(dateTimeController,
                                                    batteryController,
                                                    bleController,
                                                    notificationManager,
                                                    settingsController,
...
std::unique_ptr<Screen> Clock::WatchFaceFEPTScreen() {
  return std::make_unique<Screens::WatchFaceFEPT>(dateTimeController,
                                                     batteryController,
                                                     bleController,
                                                     notificationManager,
                                                     settingsController,
